...
public class CoffeeMakerTest 
{
	...
	public void setUp() throws RecipeException {
		...
		//Set up for recipe4
		recipe4 = new Recipe();
		recipe4.setName("Expensive Chocolate");
		recipe4.setAmtChocolate("100");
		recipe4.setAmtCoffee("100");
		recipe4.setAmtMilk("100");
		recipe4.setAmtSugar("100");
		recipe4.setPrice("60");
		...
		stubRecipies = new Recipe [] {recipe1, recipe2, recipe3,null, recipe4};
	}
	...
	public void testMakeCoffee() {
        ...
        @Test
	public void testMakeCoffeeEnough() {
                when(recipeBookStub.getRecipes()).thenReturn(stubRecipies);
		coffeeMaker = new CoffeeMaker(recipeBookStub, new Inventory());
                coffeeMaker.makeCoffee(4, 100);
		assertTrue(true);
	}
        @Test 
...
//        }
        ...
        public void recipeEquals()
        {
           ...
           assertFalse(recipe1.equals(coffeeMaker));           
           assertFalse(recipe1.equals(recipe2));           
           assertTrue(recipe1.equals(recipe5));
        }
        @Test
